...
do
	case $opt in
		...
		"Backup")
			...
			wget https://raw.githubusercontent.com/Erfan-XRay/wizwizxui-timebot/main/dbbackupwizwiz.sh | chmod +x dbbackupwizwiz.sh
			./dbbackupwizwiz.sh
